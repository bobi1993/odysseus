...
const _PROVIDERS = [
  ...
  // Cloudflare Workers AI (official cloud + AI brain mark)
  [/cloudflare|cf-/i,
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.5 2C8.36 2 5 5.36 5 9.5c0 .5.06.99.16 1.46A5.5 5.5 0 0 0 6.5 21h12a4.5 4.5 0 0 0 .93-8.91A6.5 6.5 0 0 0 12.5 2zm0 2a4.5 4.5 0 0 1 4.47 4.05l.12.75.76.08A2.5 2.5 0 0 1 19 15.5h-12a3.5 3.5 0 0 1-.7-6.93l.58-.1L7.1 7.7A4.5 4.5 0 0 1 12.5 4z"/></svg>'],

  // HuggingFace (official love/face logo)
  [/huggingface|hugging face|hf-/i,
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-1.1 0-2-.27-2.78-.73l.5-.17c.65-.22 1.35-.35 2.08-.35.73 0 1.43.13 2.08.35l.5.17c-.78.46-1.68.73-2.78.73zm-4.5-2.5c0-1.1.9-2 2-2h5c1.1 0 2 .9 2 2v.5c0 1.1-.9 2-2 2h-5c-1.1 0-2-.9-2-2v-.5zm.25-4.25a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5zm9.5 0a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5zM12 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>'],

  // Perplexity (official loop/infinity mark)
  [/perplexity|sonar/i,
  ...
  // Venice AI (V mark)
  [/venice/i,
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2.4 2.4c.6-.6 1.6-.6 2.2 0L12 12l7.4-9.6c.6-.6 1.6-.6 2.2 0 .6.6.6 1.6 0 2.2L12 16 2.4 4.6c-.6-.6-.6-1.6 0-2.2z"/></svg>'],
];
